...
const items = [
  { to: '/courses/photographer', label: 'Стань фотографом' },
  { to: '/courses/posing', label: 'Фотопозирование' },
  { to: '/courses/workshops', label: 'Практикумы' },
  { to: '/courses/reviews', label: 'Отзывы' },
];
