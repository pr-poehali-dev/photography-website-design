...
const reviews = [
  {
    name: 'Елизавета С.',
    service: 'Курс «Стань фотографом»',
    date: 'Апрель 2024',
    text: 'После курса начала зарабатывать на любимом деле. Подача — золото. Чувствуется, что тебя ведут от первой настройки до первого клиента.',
    rating: 5,
  },
  {
    name: 'Игорь М.',
    service: 'Фотопозирование',
    date: 'Март 2024',
    text: 'Позирование перестало быть страшным словом. Спасибо за практику и за то, что не пришлось мучительно «придумывать» позы клиентам.',
    rating: 5,
  },
  {
    name: 'Софья А.',
    service: 'Практикум',
    date: 'Февраль 2024',
    text: 'Практикум дал больше, чем год самообучения по YouTube. Один день — и понимаю, как работает свет.',
    rating: 5,
  },
  {
    name: 'Дарья К.',
    service: 'Курс «Стань фотографом»',
    date: 'Январь 2024',
    text: 'Обратная связь — самое ценное. Каждое моё задание разбирали лично. После курса у меня появилось стабильное портфолио и первые заказы.',
    rating: 5,
  },
  {
    name: 'Алексей Б.',
    service: 'Практикум',
    date: 'Декабрь 2023',
    text: 'Студийный практикум собрал в голове все схемы света, которые читал в книгах годами. Очень рекомендую тем, кто застрял в теории.',
    rating: 5,
  },
  {
    name: 'Полина Н.',
    service: 'Фотопозирование',
    date: 'Ноябрь 2023',
    text: 'Я модель, и теперь точно знаю, что делать с руками, плечами и взглядом. Каждая съёмка стала увереннее в три раза.',
    rating: 5,
  },
];

const filters = ['Все', 'Курс', 'Позирование', 'Практикум'];

const stats = [
  { num: '4.97', label: 'средняя оценка' },
  { num: '320+', label: 'выпускников' },
  { num: '78%', label: 'снимают за деньги' },
  { num: '12', label: 'потоков курса' },
];
    ...
    <div className="min-h-screen bg-[#FBFAF7] text-neutral-900 font-sans">
      ...
      <section className="px-6 lg:px-12 max-w-[1400px] mx-auto pb-20">
        <div className="grid grid-cols-12 gap-6 items-end">
          <div className="col-span-12 md:col-span-2 text-xs tracking-[0.3em] uppercase text-neutral-500 animate-fade-in">— Выпускники</div>
        ...
        <p className="mt-10 max-w-2xl text-lg font-light text-neutral-600 leading-relaxed animate-fade-in" style={{ animationDelay: '0.3s', opacity: 0 }}>
          Истории тех, кто прошёл курсы и практикумы. Самое ценное — что они продолжают снимать.
        </p>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-6xl leading-[1.05]">
              Учились <span className="italic font-light">у меня?</span>
            </h2>
            <p className="mt-6 text-base font-light text-neutral-700 max-w-md">
              Расскажите, как изменился ваш взгляд на съёмку. Эти слова помогут будущим выпускникам сделать выбор.
            </p>
          </div>
